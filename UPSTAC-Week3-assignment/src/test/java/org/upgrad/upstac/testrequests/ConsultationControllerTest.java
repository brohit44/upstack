...
class ConsultationControllerTest {
    ...
    public void calling_assignForConsultation_with_valid_test_request_id_should_update_the_request_status(){
        ...
        TestRequest testRequestNew = consultationController.assignForConsultation(testRequest.getRequestId());
        assertThat(testRequest.getRequestId(),is(equalTo(testRequestNew.getRequestId())));
        assertThat(testRequest.getStatus(),is(equalTo(testRequestNew.getStatus())));
        assertNotNull(testRequestNew.getConsultation());
